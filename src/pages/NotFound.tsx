...
export const NotFound = () => {
  ...
  return (
    <div className="relative h-full min-h-0 overflow-hidden bg-brand-bg text-brand-ink">
      ...
      <div className="relative mx-auto flex h-full max-w-[1120px] items-center px-4 py-3 sm:px-5 sm:py-4 lg:px-8 lg:py-4">
        <div className="grid w-full gap-4 lg:grid-cols-[minmax(0,0.84fr)_minmax(0,0.9fr)] lg:items-center">
          <motion.div
          ...
          >
            ...
            <h1
              className="mt-3 max-w-[13.5ch] font-sans text-white normal-case tracking-[-0.01em]"
              style={{ fontSize: 'clamp(2rem, 4.15vw, 4rem)', lineHeight: 0.92, wordSpacing: '0.06em' }}
            >
              This page wandered off for a coffee break.
            </h1>
            <p className="mt-2.5 max-w-[22rem] text-sm leading-5.5 text-white/62 sm:text-base">
            ...
            <div className="mt-4 hidden flex-wrap items-center gap-x-4 gap-y-2 font-mono text-[10px] uppercase tracking-[0.2em] text-white/38 sm:flex">
              ...
              <span><span className="text-white/76">M</span> music</span>
            </div>

            <div className="mt-3 flex flex-wrap items-center gap-3 font-mono text-[9px] uppercase tracking-[0.2em] text-white/34">
          ...
          >
            <div className="relative ml-auto w-full max-w-[460px] overflow-hidden rounded-[1.6rem] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.05),rgba(255,255,255,0.015))] p-3.5 shadow-[0_32px_90px_rgba(0,0,0,0.38)] backdrop-blur-xl sm:p-4">
              ...
              <div className="relative z-10">
                ...
                <div className="mt-3.5 flex flex-col items-center">
                  <div
                    className="relative w-full overflow-hidden rounded-[1.35rem] border border-white/10 bg-[#0c0c0c] p-2"
                    style={{ maxWidth: 'min(18rem, 29vh)' }}
                  >
                    ...
                    {!snapshot.running ? (
                      <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#0a0a0a]/78 px-6 text-center backdrop-blur-sm">
                        ...
                        <h2
                          className="mt-2 max-w-[14ch] font-sans text-[1.45rem] normal-case tracking-[-0.01em] text-white sm:text-[1.8rem]"
                          style={{ wordSpacing: '0.06em' }}
                        >
                          {snapshot.gameOver ? 'Try another stack.' : 'Build the neatest coffee tower you can.'}
                        </h2>
                        <p className="mt-2 max-w-[18rem] text-sm leading-5 text-white/58">
                          {snapshot.gameOver
                  ...
                  <div className="mt-2.5 grid w-full grid-cols-4 gap-1.5 sm:hidden" style={{ maxWidth: 'min(18rem, 29vh)' }}>
